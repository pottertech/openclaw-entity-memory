...
export function createAlertHistoryRouter(pool) {
    const router = createRouter();
    router.get("/canary-dashboard/outage-impact/alert-history", async (req, res) => {
        ...
        const history = thresholdResult.rows.map((row) => {
