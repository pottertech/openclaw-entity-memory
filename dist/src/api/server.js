...
export async function createServer(config) {
    ...
    const traversalService = new AccessAwareTraversalService(entityRepository, edgeRepository, graphAdapter, aclService, edgeAclService, conflictResolutionService);
