export type RelationshipRoutingSignal = {
  shouldUseEntityMemory: boolean;
...
export function classifyRelationshipQuery(
  question: string,
): RelationshipRoutingSignal {
  const matched = RELATIONSHIP_PATTERNS.filter((pattern) =>
