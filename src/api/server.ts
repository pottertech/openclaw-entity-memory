...
export async function createServer(config: AppConfig): Promise<Express> {
  ...
  const provenanceWeightedConflictService =
    new ProvenanceWeightedConflictService();
  ...
  const traversalService = new AccessAwareTraversalService(
    entityRepository,
    edgeRepository,
    graphAdapter,
    aclService,
  ...
  const impactQueryService = new ImpactQueryService(
    entityService,
    entityRepository,
    traversalService,
    edgeRepository,
  ...
  app.use(
    ...
    createQueryRouter(
      entityService,
      traversalService as unknown as import("../query/traversal.js").TraversalService,
      hybridQueryService,
      impactQueryService,
      queryAuditService,
    ),
